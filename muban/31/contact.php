...
{{file header}}
    ...
    <section class="{{z(class)|upset_class()}} section section-sm section-last bg-default text-start">
        <div class="{{z(class)|upset_class()}} container">
            ...
            <form class="{{z(class)|upset_class()}} rd-form rd-form-variant-2 rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="{{host}}">
                ...
                <button class="{{z(class)|upset_class()}} button button-primary button-pipaluk" type="submit">Send Message</button>
            </form>
        </div>
    </section>
{{file footer}}

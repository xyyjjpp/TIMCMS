...
<body>
{{file header}}
<div data-app-id="{{z(class)|upset_class()}}" class="breatcumb-area d-flex align-items-center" style="background-image: url('{{if i('cid') == 3}} {{z(works_banner_img)}} {{elseif i('cid') == 4}} {{z(news_banner_img)}} {{/if}}')">
...
<div data-app-id="{{z(class)|upset_class()}}" class="blog_area blog-details-area rs pt-115 pb-90" id="blog">
    <div data-app-id="{{z(class)|upset_class()}}" class="container">
        <div data-app-id="{{z(class)|upset_class()}}" class="row">
            <div data-app-id="{{z(class)|upset_class()}}" class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                <div data-app-id="{{z(class)|upset_class()}}" class="row">
                    <div data-app-id="{{z(class)|upset_class()}}" class="col-md-12">
                        <div data-app-id="{{z(class)|upset_class()}}" class="dreamit-single-blog-box">
                            <div data-app-id="{{z(class)|upset_class()}}" class="em-blog-content">
                                ...
                                <br>
                                <div data-app-id="{{z(class)|upset_class()}}" class="blog-page-title pt-3">
                                    {{$article['content']}}
                                </div>
                                {{$prevset=array()}}
            ...
            <div data-app-id="{{z(class)|upset_class()}}" class=" col-lg-4 col-md-6 col-sm-12 col-xs-12 sidebar-right content-widget pdsr">

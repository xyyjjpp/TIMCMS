...
<body>
{{file header}}
<div data-app-id="{{z(class)|upset_class()}}" class="breatcumb-area d-flex align-items-center" style="background-image: url('{{z(news_banner_img)}}')">
...
<div data-app-id="{{z(class)|upset_class()}}" class="blog-details-area rs pt-115 pb-90" id="blog">
    <div data-app-id="{{z(class)|upset_class()}}" class="container">
        <div data-app-id="{{z(class)|upset_class()}}" class="row">
            <div data-app-id="{{z(class)|upset_class()}}" class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <div data-app-id="{{z(class)|upset_class()}}" class="row">
                    ...
                    <div data-app-id="{{z(class)|upset_class()}}" class="col-lg-6 col-sm-12">
                        <div data-app-id="{{z(class)|upset_class()}}" class="single_blog">
